...
struct Constants {
    static let API_KEY = "46a5d948c64e7f2243152d4d163fed7c" //Enter your API KEY here
...
class APICaller {
    ...
    func getNewMovies(completion: @escaping (Result<[Movie], Error>) -> Void) {
        guard let url = URL(string: "\(Constants.baseURL)/3/movie/latest?api_key=\(Constants.API_KEY)&language=en-US") else {return}
